...
export default function Question() {
 ...
 async function generateAnswer(){
         console.log("loding....")
  const response = await axios({url:"https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=AIeaSywjJYVWix7gT1sg5rRCHX-IfmqLUbisfbo",
  method:"post" ,
  data: {
    "contents": [
      {
